      ...
      <table className='w-full text-sm text-left rtl:text-right'>
        ...
        <tbody>
          <tr className='odd:bg-gray-100 even:bg-gray-50 border-b border-gray-200'>
            <th scope='row' className='px-6 py-4 font-medium text-heading whitespace-nowrap'>PayTrack</th>
            <td className='px-6 py-4'>Hour tracking website for individuals and companies</td>
